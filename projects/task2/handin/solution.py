...
class SWAGInference(object):
    ...
    def set_params(self):
        # {'swag_epochs': 34, 'swag_lr': 0.009035119926400067, 'bma_samples': 28, 'prediction_threshold': 0.7117194260557609, 'matrix_rank': 17}
        self.swag_epochs = 34
        self.swag_learning_rate = 0.009035119926400067
        self.bma_samples = 28
        self._prediction_threshold = 0.7117194260557609
        self.deviation_matrix_max_rank = 17
    ...
    def predict_probabilities_swag(self, loader: torch.utils.data.DataLoader) -> torch.Tensor:
        ...
        """
        # loader should be with gpu data
        self.network.eval()
